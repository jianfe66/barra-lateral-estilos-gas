...
{
  //primero borramos es estilo de las celdas activas
  borrarEstilos();
  ...
  celdas.setBorder(true,null,null,null,null,true,estilos_sheet.getProperty('BordeSupCo' +estilo), obtenerEnumBorde(estilo.getProperty('BordeSupST' +estilo)));
  
  //borde izq
  if(comprobarBordes('izq',estilo))
  celdas.setBorder(true,null,null,null,null,true,estilos_sheet.getProperty('BordeIzqCo' +estilo), obtenerEnumBorde(estilo.getProperty('BordeIzqST' +estilo)));

  //borde inf
  if(comprobarBordes('inf',estilo))
  celdas.setBorder(true,null,null,null,null,true,estilos_sheet.getProperty('BordeInfCo' +estilo), obtenerEnumBorde(estilo.getProperty('BordeInfST' +estilo)));

  //borde der
  if(comprobarBordes('der',estilo))
  celdas.setBorder(true,null,null,null,null,true,estilos_sheet.getProperty('BordeDerCo' +estilo), obtenerEnumBorde(estilo.getProperty('BordeDerST' +estilo)));
...
function guardarBordes(celda,estilo)
{
  ...
  if(bordes != null)
  {
    ...
    //borde sup
    if(borde_sup.getColor() != nulll && borde_sup.getBorderStyle() != null )
    {
      estilos_sheet.setProperty('BordeSupCO'+estilo, borde_sup.getColor().asRgbColor().asHexString());
      estilos_sheet.setProperty('BordeSupST'+estilo, border_sup.getBorderStyle());
    }

    //borde inf
    if(borde_inf.getColor() != nulll && borde_inf.getBorderStyle() != null )
    {
      estilos_sheet.setProperty('BordeInfCO'+estilo, borde_sup.getColor().asRgbColor().asHexString());
      estilos_sheet.setProperty('BordeInfST'+estilo, border_sup.getBorderStyle());
    }



    //borde der
    if(borde_der.getColor() != nulll && borde_der.getBorderStyle() != null )
    {
      estilos_sheet.setProperty('BordeDerCO'+estilo, borde_sup.getColor().asRgbColor().asHexString());
      estilos_sheet.setProperty('BordeDerST'+estilo, border_sup.getBorderStyle());
    }

    //borde izq
    if(borde_izq.getColor() != nulll && borde_izq.getBorderStyle() != null )
    {
      estilos_sheet.setProperty('BordeIzqCO'+estilo, borde_sup.getColor().asRgbColor().asHexString());
      estilos_sheet.setProperty('BordeIzqST'+estilo, border_sup.getBorderStyle());
    }
